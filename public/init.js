...
angular.element(document).ready(function() {
	...
	//Then init the app
	angular.bootstrap(document, ['music-player']);
});
...
// Default modules
var modules = ['ngCookies', 'ngResource', 'ui.bootstrap', 'ui.router', 'music-player.system', 'music-player.about', 'music-player.auth', 'music-player.listen'];
modules = modules.concat(packageModules);

// Combined modules
angular.module('music-player', modules);
